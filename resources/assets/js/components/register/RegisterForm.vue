<template>
    <form class="form-horizontal" @submit.prevent="register">
        <div class="form-group" :class="{'has-error' : errors.has('name')}">
            ...
            <div class="col-md-7">
                <input v-model="name"
                       v-validate="'required|length:5,11'" data-vv-as="用户名"
        ...
        <div class="form-group" :class="{'has-error' : errors.has('email')}">
            ...
            <div class="col-md-7">
                <input v-model="email"
                       v-validate="'required|email'" data-vv-as="邮箱"
        ...
        <div class="form-group" :class="{'has-error' : errors.has('password')}">
            ...
            <div class="col-md-7">
                <input v-model="password"
                       v-validate="'required|length:6,11'" data-vv-as="密码"
                       ref="password"
        ...
        <div class="form-group" :class="{'has-error' : errors.has('password-confirm')}">
            ...
            <div class="col-md-7">
                <input id="password-confirm"
                       v-validate="'required|length:6,11|confirmed:password'" data-vv-as="确认密码"
